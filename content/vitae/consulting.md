...
<p>From 2012 onward I made the conscious decision to look for two things in a role: 1) to solve big challenges with modern technology and 2) support and build diverse, high-performing teams. While considering my options, I went back to the early formative experiences <a href="/vitae/mlbyaccident/">with Moog</a> and <a href="/vitae/earlydatascience/">at TherapyEdge</a> - and decided to re-focus on taking on the big problem and doing work of consequence. All of the jobs listed below started with some form of promise to fulfill those two goals. The listing below gives a highlight on the companies, problem spaces encountered, and the outcome in each client encounter.</p>
<br class="SoundFi">
