...
description: Applying Systems Thinking & Adaptive Management into a Cohesive Scaffold for Building & Managing Complex Software
draft: false
tags:
- Accessibility
- a11y
...
---
`r blogdown::shortcode("alert-perspective", "info", "Working Draft(s):", "This entry is the first of several to be published over the coming days and weeks. Instead of an extended read [I use the metaphor of Martin Luther's 95 Theses] I have opted to publish here as a loose collection of ideas and am saving the finer points for the proposed formalized site. Stay tuned!")`
