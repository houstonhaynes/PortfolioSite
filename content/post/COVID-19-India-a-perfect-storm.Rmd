...
emblem: health.png
description: The next wave in India could overtake us all
draft: true
tags:
- COVID-19
- R
...
widget <- highchart(type = "stock") %>%
  hc_add_theme(thm) %>%
  hc_title(text = "New Cases per Million - India as Case Study", align = "center") %>%
  hc_subtitle(text = "With Comparison to UK & US", align = "center") %>%
    hc_chart(
...
widget <- highchart(type = "stock") %>%
  hc_add_theme(thm) %>%
  hc_title(text = "New Deaths per Million - India as Case Study", align = "center") %>%
  hc_subtitle(text = "With Comparison to UK & US", align = "center") %>%
    hc_chart(
      borderColor = 'rgba(160, 160, 160, 0.3)',
      borderRadius = 8,
