...
I will way (or write) right off the bat that integration between AWS Amplify and GitHub repos is really slick. I started with that as a crutch since it was so easy to configure. I figured that *if* the site matured from a proof-of-concept to a fully fledges product, I could just move it over from a private GitHub repo to my company's Azure Dev Ops instance - update the endpoint and PAT - and that, as they say, would be that. 
