---
title: "Embedding Responsive Elements in an R/Blogdown Web Page"
output:
  blogdown::html_page:
    toc: false
    toc_depth: 1
...
description: Using Bootstrap and Hugo to build R-wrapped responsive page markup
draft: false
tags:
- R
- blogdown
...
`r blogdown::shortcode("url-link", "Blogdown", "https://bookdown.org/yihui/blogdown/")` is brilliant, and it offers multiple options for building a site from an R project. Jekyll and Rmarkdown's default page generators do a fine job, but there are some advantages to using Hugo as the appetite for more dynamic pages grows. One such advantage is injecting Hugo shortcodes to bring life to the body of the page. Other frameworks can decorate around the markdown page, but with Hugo you don't just have to settle for window dressing. Coupled with Bootstrap (or similar responsive framework) Hugo can make a blogdown-based site really come to life.
...
`r blogdown::shortcode("fancybox", "/img", "RBlogdown_shortcode_sample.png")`
...
<pre><code class="html"><div class="alert alert-{{ .Get 0 }} alert-dismissible fade show pb-4" role="alert">
...
`r blogdown::shortcode("fancybox", "/img", "RBlogdown_shortcode_form.png")`
...
`r blogdown::shortcode("fancybox", "/img", "RBlogdown_shortcode_render.png")`
