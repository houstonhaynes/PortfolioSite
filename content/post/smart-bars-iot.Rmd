...
Helios Bars was a promising Kickstarter project that provided a unique aftermarket solution for the the cycling enthusiast. This was in the pre-scooter-rental days where "connected" devices was definitely not the norm. It provided a built-in LED headlamp and multi-color LEDs at the bar ends. The latter could be used in an “ambient mode” or as a speed indicator. And of course the bar end lights could be triggered to indicate turns.
