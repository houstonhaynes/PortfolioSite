...
`r blogdown::shortcode("alert", "warning", "Note:", "This entry is currently under revision. SendGrid has updated its policies regarding email relay. Overall, this is a good thing. However, this not only will influence the way this site's contact form is built, but will also trigger an update to this article in the near future.")`
