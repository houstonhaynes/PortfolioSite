...
<figure><figcaption class="caption">HTML form in Contact page</figcaption><pre><code class="html"><div id="container" class="ld-over-full-inverse"><div id="output"></div> 
