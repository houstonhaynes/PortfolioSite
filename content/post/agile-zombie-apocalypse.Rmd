...
`r blogdown::shortcode("youtube2-small", id = '"EZ05e7EMOLM"', yt_start = '"1893"', yt_end = '"2052"')`
<br>
...
`r blogdown::shortcode("ext-flink-card", "https://www.buzzfeednews.com/article/ryanmac/we-found-joe-bidens-secret-venmo")` 
...
`r blogdown::shortcode("youtube2-small", id = '"07YRhcJGAJ4"')`
<br>
...
`r blogdown::shortcode("youtube2-small", id = '"cGuTmOUdFbo"')`
<br>
