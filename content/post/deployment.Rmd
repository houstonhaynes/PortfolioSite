...
---
# In Search of Repeatability
There are some trade-offs with a static site. It's faster and has a lighter footprint. 
...
<figure><figcaption class="caption">.gitignore entry to exclude local properties file</figcaption>
<pre><code class="">deploy/properties.json</code></pre>
</figure>

This is some text

<figure><figcaption class="caption">build-int.R - runs Rterm session to build blogdown site</figcaption>
...
<figure><figcaption class="caption">push.ps1 - build and deployment script</figcaption>
