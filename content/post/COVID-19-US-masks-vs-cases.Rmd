...
```{r Cumulative Cases Pop Leveled, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE  }
...
```
```{r Mask Percentage by County, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
...
widget <- hcmap("countries/us/us-all-all",
      ...
      join = "fips") %>%
  hc_colorAxis(minColor = "white", maxColor = "#32644F") %>% 
  hc_title(text = "Percentage of US Respondants Claiming to Always Wear Masks in Public", align = "center") %>%
    hc_chart(
      borderColor = 'rgba(160, 160, 160, 0.3)',
      borderRadius = 8,
      borderWidth = 2) %>%
