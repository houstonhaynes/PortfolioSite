...
description: Moving Beyond Agile Using Systems Thinking and Adaptive Management
draft: true
tags:
- Accessibility
- a11y
...
[hat tip to Peter Frank for this reference] https://www.scmagazine.com/home/security-news/vulnerabilities/namewreck-is-the-latest-collision-between-tcp-ip-and-the-standards-process/
...
## Avoiding loaded terms and buzzword bingo
...
`r blogdown::shortcode("tweet-single", "1382018677026000897")`
...
# Considering Software Design & Engineering as a Practice

#### Compare Software Design to legal, medical, civil engineering
...
### The realities of GDPR, CCPA and related standards and practices
...
## Recognizing the Earned and Inherent Limitations of Agile
