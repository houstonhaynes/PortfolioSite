...
date: '2020-11-09T14:59:43+05:30'
featuredpath: img
...
I was fairly arbitrary in my selection of countries to compare to Israel's data. I picked US and UK because the response in general has been *so poor* from a policy perspective. And as counterpoint I pulled in Canada and Germany who have better national strategies. Israel and China were chosen for their population size (even when leveled for cases per million I was expecting to see more from their data) and Japan has a pretty well-established mask culture. As you look at death and test rates below the picture continues to develop.

`r blogdown::shortcode("fancybox-iframe", "/post/COVID-19-Israel-Case-Study_files/figure-html/widgets/widget_Israel_COVID_Cases_per_Million.html")`

```{r Israel_COVID_Cases_per_Million, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
...
widget <- highchart(type = "stock") %>%
  ...
  hc_subtitle(text = "With Comparison to Japan, China, Israel, Canada, Germany, UK & US", align = "center") %>%
    hc_chart(
...
`r blogdown::shortcode("fancybox-iframe", "/post/COVID-19-Israel-Case-Study_files/figure-html/widgets/widget_Israel_COVID_Deaths_per_Million.html")`

```{r Israel_COVID_Deaths_per_Million, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
...
`r blogdown::shortcode("fancybox-iframe", "/post/COVID-19-Israel-Case-Study_files/figure-html/widgets/widget_Israel_COVID_Tests_per_Thousand.html")`

```{r Israel_COVID_Tests_per_Thousand, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
