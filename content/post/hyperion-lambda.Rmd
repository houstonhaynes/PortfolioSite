...
`r blogdown::shortcode("fancybox-dark-theme-ok", "/img", "ScreenShot2016-09-21at8.12.02PM.png")`
...
`r blogdown::shortcode("fancybox-dark-theme-ok", "/img", "SSIS_flat.png")`
...
`r blogdown::shortcode("fancybox-dark-theme-ok", "/img", "image011.png")`
...
`r blogdown::shortcode("fancybox-dark-theme-ok", "/img", "image012.png")`
...
`r blogdown::shortcode("fancybox-dark-theme-ok", "/img", "image013.png")`
...
`r blogdown::shortcode("fancybox-dark-theme-ok", "/img", "image020.png")`
...
`r blogdown::shortcode("fancybox-dark-theme-ok", "/img", "image021.png")`
...
`r blogdown::shortcode("fancybox-dark-theme-ok", "/img", "image022.jpg")`
