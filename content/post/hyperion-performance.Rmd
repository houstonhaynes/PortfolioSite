...
description: A cloud-based "speed layer" monitor for consolidation heuristics
draft: false
tags:
- Azure
- Oracle
...
`r blogdown::shortcode("fancybox", "/img", "ScreenShot2016-09-21at8.12.02PM.png")`
...
`r blogdown::shortcode("fancybox", "/img", "SSIS_flat.png")`
...
`r blogdown::shortcode("fancybox", "/img", "image011.png")`
...
`r blogdown::shortcode("fancybox", "/img", "image012.png")`
...
`r blogdown::shortcode("fancybox", "/img", "image013.png")`
...
```{r "Concurrency of Hyperion Processes"}
series = list(
  list(
    name = 'Consolidations',
...
frameWidget(hcConcurrency, height = "50%")
```
...
<pre><code class="cs">for (DateTime date = CurrentRow; CurrentRow <= PeriodEnd; CurrentRow = CurrentRow.AddSeconds(1.0)) {
...
`r blogdown::shortcode("fancybox", "/img", "image020.png")`
...
`r blogdown::shortcode("fancybox", "/img", "image021.jpg")`
...
`r blogdown::shortcode("fancybox", "/img", "image022.jpg")`
...
<iframe rc="https://app.powerbi.com/view?r=eyJrIjoiMDI4MDdlNzktZTNmYi00ZWEwLWFiMjktM2IyMWQ1MmYyNTA0IiwidCI6Ijc4N2QxYzAwLTgyMjgtNDAzYy1iZjVmLTg1YjM3NzFmM2M0MiIsImMiOjZ9"  height="600" width="960"  frameborder="0" allowFullScreen="true"></iframe>
...
<iframe src="https://app.powerbi.com/view?r=eyJrIjoiNTljZTM0ZGUtNTk4Ni00MjMxLWE1ZTYtYjJiODJiMWU4ODU5IiwidCI6Ijc4N2QxYzAwLTgyMjgtNDAzYy1iZjVmLTg1YjM3NzFmM2M0MiIsImMiOjZ9"  height="600" width="960" frameborder="0" allowFullScreen="true"></iframe>
...
<iframe src="https://app.powerbi.com/view?r=eyJrIjoiNjAyZjYzYzctN2M2Ni00YTYxLTgwODktMjVjMmUxNzllZTMzIiwidCI6Ijc4N2QxYzAwLTgyMjgtNDAzYy1iZjVmLTg1YjM3NzFmM2M0MiIsImMiOjZ9" height="600" width="960" rameborder="0" allowFullScreen="true"></iframe>
