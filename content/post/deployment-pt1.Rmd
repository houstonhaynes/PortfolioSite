...
And of course highlightjs masks the issue inline because the web abhors a double-slash. Below is a screen shot of the actual line of code in the PowerShell script.

<img class="rounded bordered img-fluid filter-none centered" src="/img/deploy-PowerShellSlashSubstitution.png"/>
