...
The following R script again sets the working directory, runs the hugo command with the baseURL parameter and then instructs the process to run without prompting.
