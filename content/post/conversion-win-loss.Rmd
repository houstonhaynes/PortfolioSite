...
<img class="ui centered rounded bordered image" src="/img/Splunk_chart.png">
...
<img class="ui centered rounded bordered image" src="/img/Splunk_perItem.png">
...
<img class="ui centered rounded bordered image" src="/img/SOLR_framework.png">
...
<pre><code class="apache">sch.solr.item.listing=q=&fq=-Merchandise:true&fq=(MajorGenreId:10001 OR
MinorGenreId:203 OR MinorGenreId:51)&fq=-ItemType:3&fq=-ItemType:4&fq=-TCode1:APE
sch.solr.exclude.mlb=fq=-AttractionOrganization:mlb
sch.solr.global.filter=
...
# `r fa("diagnoses")` Closing the Gap
