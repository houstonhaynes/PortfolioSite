...
`r blogdown::shortcode("fancybox", "/img", "Splunk-Chart.png")`

# Weblog Blind Spots

`r blogdown::shortcode("fancybox", "/img", "web_v_mobile.png")`
...
`r blogdown::shortcode("fancybox", "/img", "Splunk_chart.png")`
...
`r blogdown::shortcode("fancybox", "/img", "Splunk_perItem.png")`
...
`r blogdown::shortcode("alert", "success", "Note!", "The legend in these charts can also be used to show or hide series.")`
...
`r blogdown::shortcode("fancybox", "/img", "SOLR_framework.png")`
