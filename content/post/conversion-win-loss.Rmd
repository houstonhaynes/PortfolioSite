---
title: "Conversion Win-Loss Tracking in Global E-Commerce Platform"
output:
  blogdown::html_page:
    dev: "svg"
...
<figure><figcaption class="caption">Cart Summary Initial - Code Sample</figcaption><pre><code class="r">
series = list(
  list(
    name = 'Added',
    data = dfCartLossBefore$Added,
...
frameWidget(hcWinLossInitial)</code></pre></figure>
