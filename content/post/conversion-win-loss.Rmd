---
title: "Improving Conversion Win-Loss in Global E-Commerce Platform"
output:
  blogdown::html_page:
    dev: "svg"
...
description: Increasing mobile sell-through by re-tooling the stack
draft: false
tags:
- AWS
- micro-services
...
<pre><code class="ruby">sch.solr.item.listing=q=&fq=-Merchandise:true&fq=(MajorGenreId:10001 OR MinorGenreId:203 OR MinorGenreId:51)&fq=-ItemType:3&fq=-ItemType:4&fq=-TCode1:APE
