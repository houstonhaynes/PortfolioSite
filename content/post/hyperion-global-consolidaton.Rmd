...
dfConcurrency$Consolidation = (as.integer(dfConcurrency$Consolidation))
dfConcurrency$LargeSMV = (as.integer(dfConcurrency$LargeSMV))
dfConcurrency$TBUploads = (as.integer(dfConcurrency$TBUploads))
```
