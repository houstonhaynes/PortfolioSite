---
title: "Read-ish permissions in AWS Elemental"
output:
  blogdown::html_page:
    toc: false
    toc_depth: 1
...
description: The IAM Giveth And The IAM Taketh Away
draft: false
tags:
- AWS
- Elemental
...
`r blogdown::shortcode("url-link", "Elemental", "https://www.elemental.com/")` is versitile as an AWS service, and it dovetails well to long-standing Amazon services. This sidebar is about how I configured a "viewer+" role with the correnct permissions from S3 to CloudFront. While the role is primarily provisioned as a read resource I also included the ability to edit the Channel Schedule. That created a few wrinkles to the process I detail below.
