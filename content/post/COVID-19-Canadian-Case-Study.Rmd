---
title: "COVID-19 in Motion - Canada post-Thanksgiving"
output:
  blogdown::html_page:
    dev: "svg"
...
emblem: health.png
description: The Great White North Predicting the US Future
draft: false
tags:
- COVID-19
- R
...
Having taken a turn with the data following Israel's increase in mask-wearing compliance, I decided to look at the data in Canada after someone warned me about their Thanksgiving showing an ominous trend. Again, here I'm using <a href="https://ourworldindata.org/" target="_blank">Our World In Data</a> as a source. 

I decided to map cases and deaths per million on separate axes in order to see them scaled separately. And it's just as scary as I thought. That lagging indicator is frightening on two levels:

1) It's hard to *not* see those April numbers as terrifying, and 
1) Thinking of how *badly* things will go in the US in December.
